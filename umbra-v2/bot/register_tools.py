...
TOOL_CONFIGS = [
    ...
    },
    {
        ...
        "description": "Retrieve recent posts from a Bluesky user's profile",
        "tags": ["bluesky", "feed", "profile", "author", "posts"]
    },
    {
...
def register_tools(agent_id: str = None, tools: List[str] = None, set_env: bool = True):
    ...
    try:
        # Initialize Letta client with optional token and base_url from config
