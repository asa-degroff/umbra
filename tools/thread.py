...
def add_post_to_bluesky_reply_thread(text: str, lang: str = "en-US") -> str:
    ...
    """
    # Clean up any accidental list/array formatting from the text
    # (e.g., ["text"] or 'text' wrapping due to agent seeing List[str] examples)
    text = _clean_list_formatting(text)
